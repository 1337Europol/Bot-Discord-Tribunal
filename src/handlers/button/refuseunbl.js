...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const modal = new ModalBuilder().setCustomId(`modalrefuseunbl_${targetId}`).setTitle('refus unbl');
        const reasonInput = new TextInputBuilder().setCustomId('refuseReasonUnBL').setLabel('raison du refus').setStyle(TextInputStyle.Paragraph).setRequired(true);
